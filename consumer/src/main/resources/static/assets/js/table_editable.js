$(function () {
    ...
    function editableTable() {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[4].innerHTML = '<div class="text-center"><button type="button" class="edit btn btn-sm btn-success btn-bordered btn-flat" href="/addCargo"><i class="fa fa-save"></i></button> <a class="delete btn btn-sm btn-danger btn-bordered btn-flat" href=""><i class="fa fa-trash"></i></a></div>';
        }
